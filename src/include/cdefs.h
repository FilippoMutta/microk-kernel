...
#define INIT_INITIAL_STACK_SIZE (1 * 1024 * 1024)
...
typedef enum {
	...
	// ARCH
	SYSCALL_VECTOR_ARCH_READ_MSR,
	SYSCALL_VECTOR_ARCH_WRITE_MSR,
...
typedef enum {
	// CONTAINERS
	HYPERCALL_VECTOR_START_CONTAINER,
	HYPERCALL_VECTOR_STOP_CONTAINER,
	HYPERCALL_VECTOR_CREATE_CONTAINER,
	HYPERCALL_VECTOR_CLONE_CONTAINER,
	HYPERCALL_VECTOR_DESTROY_CONTAINER,
	HYPERCALL_VECTOR_REGISTER_IRQ,

	//END
	HYPERCALL_VECTOR_END,
} HYPERCALL_VECTOR;
